...
/*
 * Para probarla se coloca de la siguiente forma
 * http://localhost:8080/enterprise/enterprise/1 el 1 es el id a
 * consultar
 */
/*
 ...
 * respuesta
 */
// return new ResponseEntity<>(s.getRespuestaEmpresa(),
// HttpStatus.INTERNAL_SERVER_ERROR); /* Se muestra el error
 ...
 * }
 * 
 * Las lineas 44, 45, 46, 47, 58, 59, y 60 son los datos nuevos para la tabla
 * empresa, los demas datos no se cambian, esos
 * ya vienen definidos por las otras clases, si se cambian generan error
 */
/*
 * @PostMapping("/enterprise")
 * public ResponseEntity<String> crearDatos(@RequestBody Empresa
 * empresa_parametro){
 * try { /* Retorna un mensaje de exito o de error
 */
// String men = servEmpresa.addempresa(empresa_parametro); /* La variable men se
// crea aqui mismo y servEmpresa
// es la variable que hay en esta clase */
// return new ResponseEntity<>(men, HttpStatus.OK);
// }catch (Exception e){
// return new ResponseEntity<>("La empresa ya existe",
...
/*
 * Para probar este metodo nos vamos a la url http://localhost:8080/enterprise/1
 * en postman, seleccionamos el
 * metodo Patch, seleccionamos el boton body, seleccionamos raw, luego cambiamos
 * text por JSON y escribimos lo
 * siguiente:
 * {
 * "nombre": "Porvenir",
 * "nit": "14585",
 ...
 * }catch (Exception e){
 * return new
 * ResponseEntity<>("El id de la empresa no se logro encontrar para eliminarla",
 * HttpStatus.INTERNAL_SERVER_ERROR);
 * }
 * }
 * }
