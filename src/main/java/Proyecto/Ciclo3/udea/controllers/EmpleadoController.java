 ...
 * return new ResponseEntity<>(s.getRespuestaEmpleado(),
 ...
 * 
 * @PostMapping("/users")
 * public ResponseEntity<String> crearDatos(@RequestBody Empleado
 * empleadoRegistro){
 * try {
 ...
 * 
 * }catch (Exception e){
 * return new ResponseEntity<>("El empleado ya existe",
 * HttpStatus.INTERNAL_SERVER_ERROR);
 * }
 * }
 * 
 ...
 * public ResponseEntity<String> actualizarDatos(@RequestBody Empleado
 * empleadoRegistro, @PathVariable Integer id){
 * try {
 * servEmpleado.updateEmpleado(empleadoRegistro, id);
 * return new ResponseEntity<>("Se actualizo el empleado correctamente",
 * HttpStatus.OK);
 * }catch (Exception e){
 * return new ResponseEntity<>("El id del empleado no esta en la base de datos",
 * HttpStatus.INTERNAL_SERVER_ERROR);
 * }
 * }
 * 
 ...
 * }catch (Exception e){
 * return new
 * ResponseEntity<>("El id del empleado no se logro encontrar para eliminarla",
 * HttpStatus.INTERNAL_SERVER_ERROR);
 * }
 * }
 * }
